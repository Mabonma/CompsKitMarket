...
namespace CompsKitMarket.Extensions
{
    ...
    {
        public static IdentityBuilder AddRussianErrorDescriber(this IdentityBuilder builder)
        {
            builder.AddErrorDescriber<CustomIdentityErrorDescriber>();

            return builder;
        }

        private class CustomIdentityErrorDescriber : IdentityErrorDescriber
        {
