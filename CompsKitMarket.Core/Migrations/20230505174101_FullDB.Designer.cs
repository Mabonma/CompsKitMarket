...
namespace CompsKitMarket.Core.Migrations
{
    ...
    [Migration("20230505174101_FullDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManufacturerPart", b =>
                {
                    ...
                    b.HasKey("ManufacturersId", "PartsId");

                    b.HasIndex("PartsId");

                    b.ToTable("ManufacturerPart");
                });
            ...
            modelBuilder.Entity("ImagePart", b =>
                {
                    b.HasOne("CompsKitMarket.Core.Entities.Image", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ManufacturerPart", b =>
                {
                    b.HasOne("CompsKitMarket.Core.Entities.Orders.Manufacturer", null)
                        .WithMany()
